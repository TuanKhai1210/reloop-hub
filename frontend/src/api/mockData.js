...
const baseSummary = {
  ...
  near_full_hubs: 1,
  offline_hubs: 0,
  camera_online_hubs: 4,
  sensor_online_hubs: 4,
...
export const mockHubs = [
  {
    ...
    location_name: 'B3 - Postgraduate Study Office',
    status: 'ACTIVE',
    pet_capacity: 500,
    hdpe_capacity: 250,
    pet_current: 374,
  ...
  },
  {
    ...
    code: 'CANTEEN-02',
    name: 'Canteen 2 Hub',
    location_name: 'Canteen 2 - B4/B6 cluster',
    status: 'NEAR_FULL',
    pet_capacity: 500,
    hdpe_capacity: 250,
    pet_current: 188,
  ...
  },
  {
    ...
    code: 'CANTEEN-03',
    name: 'Canteen 3 Hub',
    location_name: 'Canteen 3 - C1 cluster',
    status: 'ACTIVE',
    pet_capacity: 400,
    hdpe_capacity: 200,
    pet_current: 104,
  ...
  },
  {
    ...
    camera_online: true,
    sensor_online: true,
    last_seen_at: '2026-07-13T05:19:00Z',
  },
]
